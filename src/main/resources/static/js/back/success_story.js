...
function initIdentityBtn() {
    var data = {"all": -1, "checked": 1, "uncheck": 2, "rightcheched": 3, "down": 0};
    $("button[id^='story-btn-']").click(function () {
        $("button[id^='story-btn-']").removeClass("btn-warning");
        $(this).addClass("btn-warning");
        status = data[this.id.split("-")[2]];
        goPage(1);
    })
}
