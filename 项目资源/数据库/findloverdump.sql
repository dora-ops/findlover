...
MySQL - 5.5.40 : Database - findlover
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`findlover` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
/*Data for the table `essay_photo` */
...
/*Data for the table `message_like` */
...
/*Data for the table `success_story` */
...
/*Data for the table `success_story_like` */
...
/*Data for the table `success_story_reply` */
...
/*Data for the table `taocan` */

insert  into `taocan`(`taocan_id`,`search_display_image`,`display_image_id`,`title`,`introduce`,`low_price`,`high_price`,`activity_form`,`activity_place`,`enable_area`,`taocan_type_a`,`taocan_type_a_price`,`taocan_type_b`,`taocan_type_b_price`,`taocan_type_c`,`taocan_type_c_price`,`introduce_image_id`) values ('3','logo.png','1','浪漫爱情岛','浪漫爱情岛','999','9999','雅典','雅典','雅典','欧洲','555','旅游','888','中介','333','111'),('3','logo.png','1','浪漫爱情岛','浪漫爱情岛','999','9999','雅典','雅典','雅典','欧洲','555','旅游','888','中介','333','111'),('3','logo.png','1','浪漫爱情岛','浪漫爱情岛','999','9999','雅典','雅典','雅典','欧洲','555','旅游','888','中介','333','111'),('3','logo.png','1','浪漫爱情岛','浪漫爱情岛','999','9999','雅典','雅典','雅典','欧洲','555','旅游','888','中介','333','111'),('3','logo.png','1','浪漫爱情岛','浪漫爱情岛','999','9999','雅典','雅典','雅典','欧洲','555','旅游','888','中介','333','111'),('3','logo.png','1','浪漫爱情岛','浪漫爱情岛','999','9999','雅典','雅典','雅典','欧洲','555','旅游','888','中介','333','111'),('3','logo.png','1','浪漫爱情岛','浪漫爱情岛','999','9999','雅典','雅典','雅典','欧洲','555','旅游','888','中介','333','111'),('2','logo.png','1','浪漫爱情岛','浪漫爱情岛','999','9999','雅典','雅典','雅典','欧洲','555','旅游','888','中介','333','111');
...
insert  into `user_label`(`user_id`,`label_id`) values (100000,1),(100004,1),(100007,1),(100001,1),(100001,2),(100008,1),(100008,2),(100008,3),(100008,5),(100008,4),(100011,5),(100012,3),(100012,5),(100046,1),(100046,2),(100025,2),(100026,3),(100027,5),(100028,4),(100029,5),(100030,3),(100031,2),(100032,2),(100033,4),(100034,1),(100035,2),(100036,2),(100037,3),(100033,5),(100034,4),(100035,5),(100025,1),(100026,1),(100027,1),(100028,1),(100029,1),(100030,1),(100031,1),(100032,1),(100033,1),(100034,2),(100035,1),(100036,1),(100037,1),(100025,6),(100026,6),(100027,6),(100028,6),(100029,6),(100030,6),(100031,6),(100032,6),(100033,6),(100034,6),(100035,6),(100036,6),(100037,6),(100038,6),(100008,6),(100009,6),(100010,6),(100011,6),(100012,6),(100015,6),(100016,6),(100017,6),(100018,6),(100019,6),(100020,6),(100047,1),(100005,3),(100005,5),(100012,1),(100012,2),(100048,1),(100048,2),(100052,2);
...
/*Data for the table `visit_trace` */
...
/*Data for the table `writer_essay_like` */
...
/* Trigger structure for table `essay` */

DELIMITER $$

/*!50003 DROP TRIGGER*//*!50032 IF EXISTS */ /*!50003 `Trigger_writer_essay` */$$

/*!50003 CREATE */ /*!50017 DEFINER = 'root'@'%' */ /*!50003 TRIGGER `Trigger_writer_essay` AFTER INSERT ON `essay` FOR EACH ROW update writer set essay_count=essay_count+1 where id=new.writer_id */$$
...
/*!50003 DROP TRIGGER*//*!50032 IF EXISTS */ /*!50003 `Trigger_writer_essay_del` */$$

/*!50003 CREATE */ /*!50017 DEFINER = 'root'@'%' */ /*!50003 TRIGGER `Trigger_writer_essay_del` AFTER DELETE ON `essay` FOR EACH ROW   UPDATE writer set essay_count=essay_count-1 WHERE id=old.writer_id */$$


DELIMITER ;

/* Trigger structure for table `message_like` */

DELIMITER $$

/*!50003 DROP TRIGGER*//*!50032 IF EXISTS */ /*!50003 `Trigger_msgreplylike` */$$

/*!50003 CREATE */ /*!50017 DEFINER = 'root'@'%' */ /*!50003 TRIGGER `Trigger_msgreplylike` AFTER INSERT ON `message_like` FOR EACH ROW update message set like_count=like_count+1 where id=new.message_id */$$


DELIMITER ;

/* Trigger structure for table `message_reply` */

DELIMITER $$

/*!50003 DROP TRIGGER*//*!50032 IF EXISTS */ /*!50003 `Trigger_msg_reply` */$$

/*!50003 CREATE */ /*!50017 DEFINER = 'root'@'%' */ /*!50003 TRIGGER `Trigger_msg_reply` AFTER INSERT ON `message_reply` FOR EACH ROW update message set reply_count=reply_count+1 where id=new.message_id */$$


DELIMITER ;

/* Trigger structure for table `success_story_like` */

DELIMITER $$

/*!50003 DROP TRIGGER*//*!50032 IF EXISTS */ /*!50003 `trigger_sslike` */$$

/*!50003 CREATE */ /*!50017 DEFINER = 'root'@'%' */ /*!50003 TRIGGER `trigger_sslike` AFTER INSERT ON `success_story_like` FOR EACH ROW update success_story set like_count=like_count+1 where id=new.success_story_id */$$


DELIMITER ;

/* Trigger structure for table `success_story_reply` */

DELIMITER $$

/*!50003 DROP TRIGGER*//*!50032 IF EXISTS */ /*!50003 `trigger_ssreply` */$$

/*!50003 CREATE */ /*!50017 DEFINER = 'root'@'%' */ /*!50003 TRIGGER `trigger_ssreply` AFTER INSERT ON `success_story_reply` FOR EACH ROW update success_story set reply_count=reply_count+1 where id=new.ss_id */$$


DELIMITER ;

/* Trigger structure for table `user_basic` */

DELIMITER $$

/*!50003 DROP TRIGGER*//*!50032 IF EXISTS */ /*!50003 `trigger_seletterxual` */$$

/*!50003 CREATE */ /*!50017 DEFINER = 'root'@'%' */ /*!50003 TRIGGER `trigger_seletterxual` AFTER UPDATE ON `user_basic` FOR EACH ROW update user_pick set sex=new.sexual where id=new.id */$$


DELIMITER ;

/* Trigger structure for table `writer_essay_like` */

DELIMITER $$

/*!50003 DROP TRIGGER*//*!50032 IF EXISTS */ /*!50003 `Trigger_essay_like` */$$

/*!50003 CREATE */ /*!50017 DEFINER = 'root'@'%' */ /*!50003 TRIGGER `Trigger_essay_like` AFTER INSERT ON `writer_essay_like` FOR EACH ROW update essay set like_count=like_count+1 where id=new.essay_id */$$
